...
namespace Azir.ModbusServer.RTU.SeriaPort
{
    public static class SerialPorConfigerHelper
    {
        ...
        /// <returns></returns>
        public static SerialPort GetSerialPortFormConfigFile(string serialPortConfigFile)
        {
        ...
        public static void SaveSerialPortToConfigFile(SerialPort serialPort, string serialPortConfigFile)
        {
            try
            {
                if (System.IO.File.Exists(serialPortConfigFile))
