    ...
    public static class DataPointGrouper
    {
        ...
        public static List<List<DataPoint>> GroupingDataPointsForWriteRegister(List<DataPoint> dataPoints)
        {
            ...
            foreach (var deviceAddressGroup in groupingByDeviceAddress)
            {
                ...
                foreach (var dataPointTypeGroup in groupingByDataPointType)
                {
                    Dictionary<DataType, List<DataPoint>> groupingByDataType =
        ...
        private static Dictionary<DataType, List<DataPoint>> GroupingDataPointByDataType(List<DataPoint> dataPoints)
        {
            Dictionary<DataType, List<DataPoint>> result = new Dictionary<DataType, List<DataPoint>>();
            ...
            result.Add(DataType.S16, dataPointsS16);
            result.Add(DataType.U16, dataPointsU16);
            result.Add(DataType.S32, dataPointsS32);
            result.Add(DataType.U32, dataPointsU32);
            result.Add(DataType.S64, dataPointsS64);
            result.Add(DataType.U64, dataPointsU64);
            result.Add(DataType.F32, dataPointsF32);
            result.Add(DataType.D64, dataPointsD64);
            result.Add(DataType.Bit, dataPointsBit);
