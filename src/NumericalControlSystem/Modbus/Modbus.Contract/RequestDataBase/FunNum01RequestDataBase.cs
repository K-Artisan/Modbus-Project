...
namespace Modbus.Contract.RequestDataBase
{
    ...
    /// TCP、RTU等共用
    /// </summary>
    public class FunNum01RequestDataBase : IFunNumRequestDataBase
    {
        ...
        public byte NumOfRegisterToReadHigh { get; set; }         //将要读取的寄存器数高8位
        public byte NumOfRegisterToReadLow { get; set; }          //将要读取的寄存器数低8位
